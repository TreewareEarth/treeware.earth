...
<main class="w-full">
    ...
    <!-- start hero section -->
    <section class="relative bg-blue-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-32 pb-24 sm:pb-64 md:pt-40 md:pb-48 lg:pt-40 xl:pb-48 2xl:pt-56 2xl:pb-96 text-center sm:text-left">
        <div>
            <div class="relative w-full sm:w-2/3 lg:w-1/2 z-10">
                <h1 class="text-3xl lg:text-4xl xl:text-5xl leading-tight font-bold text-yellow-800">Treeware</h1>
                <p class="text-base leading-snug text-gray-700 mt-4 text-yellow-800 text-xl">Treeware is a style of software distribution similar to Postcardware, distributed by the author on the condition that users buy the author a tree.</p>
                <a href="#" class="w-full block sm:inline-block sm:w-auto px-6 py-4 bg-green-600 text-white rounded-lg mt-8">Add your package</a>
            </div>

            <div class="w-full absolute bottom-0 right-0 text-center;" style="margin-bottom: -100px;z-index: 100;">
                <img style="margin: auto;" src="/img/tree-grow-no-bg.png" alt="">
            </div>
        </div>
    </section>
    <!-- end hero section -->
