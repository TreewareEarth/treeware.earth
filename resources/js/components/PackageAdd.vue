                    ...
                    <div class="px-6 py-8">
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <div class="text-sm text-left">
                                ...
                                <div v-if="parseInt(packagedata.clicks_count) > 0">
                                    <p class="text-black leading-none mt-1"><span class="">{{ packagedata.clicks_count }}</span> Badge Click<span v-if="parseInt(packagedata.clicks_count) > 1">s</span></p>
                                </div>
